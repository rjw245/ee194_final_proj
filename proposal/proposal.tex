...
programmer with efficient usage of the parallel cores. It is difficult for most
...
strict compile-time rules and ``extra runtime book-keeping'' have an adverse
effect on performance~\cite{rust-lang-org}.
